...
const columns = [
  ...
  { title: "Tipo de Trabajo", key: "teamType" },
...
onMounted(async () => {
  await store.setTeamsModalCreateisOpen();
...
const click = () => {
  ...
  store.setTeamsModalCreateisOpen(true);
}
...
<template>
  <LayoutAuthenticated>
    <SectionMain>
      <SectionTitleLineWithButton :icon="mdiTableBorder" title="Equipos" main>
